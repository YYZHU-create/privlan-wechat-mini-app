...
async function cleanupFixture(fixture) {
  ...
  const removals = [
    ...
    ["marketing_redemptions", { tenant_id: tenantId }],
    ["marketing_issuances", { tenant_id: tenantId }],
    ["marketing_campaigns", { tenant_id: tenantId }],
    ["marketing_offers", { tenant_id: tenantId }],
    ["marketing_audiences", { tenant_id: tenantId }],
    ...
    ["workspace_media_folders", { tenant_id: tenantId }],
    ["assets", { tenant_id: tenantId }],
    ["ai_template_draft_revisions", { tenant_id: tenantId }],
    ["ai_template_drafts", { tenant_id: tenantId }],
    ["ai_template_request_receipts", { tenant_id: tenantId }],
    ["ai_credit_ledger", { tenant_id: tenantId }],
    ["ai_credit_accounts", { tenant_id: tenantId }],
    ["ai_workspace_skills", { tenant_id: tenantId }],
    ["workspace_configs", { tenant_id: tenantId }],
    ["merchant_ai_policies", { tenant_id: tenantId }],
    ["merchant_ai_connections", { tenant_id: tenantId }],
