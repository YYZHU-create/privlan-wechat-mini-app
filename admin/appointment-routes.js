...
function registerMerchantAppointmentRoutes(app) {
  ...
  app.get("/v1/staff", async (req,res) => { try { return ok(res,await service(req).listStaff(req.merchantScope),"员工已获取",200,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.post("/v1/staff", async (req,res) => { try { return ok(res,await service(req).saveStaff(req.merchantScope,req.body||{}),"员工已创建",201,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.get("/v1/staff/:id", async (req,res) => { try { return ok(res,await service(req).getStaff(req.merchantScope,req.params.id),"员工详情已获取",200,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.patch("/v1/staff/:id", async (req,res) => { try { return ok(res,await service(req).saveStaff(req.merchantScope,req.body||{},req.params.id),"员工已更新",200,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.put("/v1/staff/:id/assignments", async (req,res) => { try { return ok(res,await service(req).replaceStaffAssignments(req.merchantScope,req.params.id,req.body||{}),"员工门店归属已更新",200,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.put("/v1/staff/:id/capabilities", async (req,res) => { try { return ok(res,await service(req).setStaffCapabilities(req.merchantScope,req.params.id,req.body||{}),"员工服务能力已更新",200,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.get("/v1/staff/:id/schedules", async (req,res) => { try { return ok(res,await service(req).listStaffSchedules(req.merchantScope,req.params.id),"员工工作时间已获取",200,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.put("/v1/staff/:id/schedules", async (req,res) => { try { return ok(res,await service(req).replaceStaffSchedules(req.merchantScope,req.params.id,req.body||{}),"员工工作时间已更新",200,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.get("/v1/staff/:id/leaves", async (req,res) => { try { return ok(res,await service(req).listStaffLeaves(req.merchantScope,req.params.id),"员工请假记录已获取",200,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.post("/v1/staff/:id/leaves", async (req,res) => { try { return ok(res,await service(req).saveStaffLeave(req.merchantScope,req.params.id,req.body||{}),"员工请假已记录",201,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.delete("/v1/staff/:id/leaves/:leaveId", async (req,res) => { try { return ok(res,await service(req).removeStaffLeave(req.merchantScope,req.params.id,req.params.leaveId),"员工请假已删除",200,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.get("/v1/appointment-resources", async (req,res) => { try { return ok(res,await service(req).listResources(req.merchantScope),"预约资源已获取",200,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.post("/v1/appointment-resources", async (req,res) => { try { return ok(res,await service(req).saveResource(req.merchantScope,req.body||{}),"预约资源已创建",201,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.patch("/v1/appointment-resources/:id", async (req,res) => { try { return ok(res,await service(req).saveResource(req.merchantScope,req.body||{},req.params.id),"预约资源已更新",200,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
  app.put("/v1/appointment-resources/:id/assignments", async (req,res) => { try { return ok(res,await service(req).replaceResourceAssignments(req.merchantScope,req.params.id,req.body||{}),"预约资源门店归属已更新",200,req.requestId); } catch(error){ return fail(res,error,req.requestId); } });
