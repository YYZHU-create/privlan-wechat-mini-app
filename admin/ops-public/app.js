  ...
  setup() {
    ...
    async function loadData() {
      ...
      try {
        ...
        await loadHealth();
      } catch (err) { error.value = err.message; await loadHealth(); }
    }
