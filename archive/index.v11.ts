...
/** merchant-routes.js:161-164 —— 浏览器传入的 scope 与会话不符直接拒 */
async function assertScopeNotOverridden(req: Request, scope: Scope, url: URL) {
...
async function handle(req: Request): Promise<Response> {
  ...
  await assertScopeNotOverridden(req, scope, url);
